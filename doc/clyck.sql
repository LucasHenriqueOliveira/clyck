...
-- Schema clyck
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `clyck` DEFAULT CHARACTER SET utf8 ;
USE `clyck` ;
...
CREATE TABLE IF NOT EXISTS `clyck`.`product` (
  ...
  `product_user_id` INT NULL DEFAULT NULL,
...
-- Table `clyck`.`sector`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `clyck`.`sector` (
  `sector_id` INT NOT NULL AUTO_INCREMENT,
  `sector_name` VARCHAR(45) NOT NULL,
  `sector_position` VARCHAR(45) NULL,
  `sector_user_id` INT NOT NULL,
  `sector_event_id` INT NOT NULL,
  PRIMARY KEY (`sector_id`),
  INDEX `fk_sector_user_idx` (`sector_user_id` ASC),
  INDEX `fk_sector_event_idx` (`sector_event_id` ASC),
  CONSTRAINT `fk_sector_user`
    FOREIGN KEY (`sector_user_id`)
    REFERENCES `clyck`.`user` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_sector_event`
